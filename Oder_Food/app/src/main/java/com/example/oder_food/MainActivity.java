...
public class MainActivity extends AppCompatActivity {
   ...
   // final int position = list_food.getPositionForView( (View) view.getParent());
    @Override
    ...
    private void Controls() {
        ...
        array_food.add(new item_food("Le Truong Thinh dep zai","MSV 2050531200339", R.drawable.thinhdz));
